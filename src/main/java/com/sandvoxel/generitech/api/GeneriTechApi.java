...
import com.sandvoxel.generitech.api.exceptions.CoreInaccessibleException;

import java.lang.reflect.Field;

public enum GeneriTechApi {
    ;

    private static final String CORE_API_FQN = "com.sandvoxel.generitech.common.core.api";
    private static final String CORE_API_FIELD = "INSTANCE";
    private static final IGeneriTechApi HELD_API;
    ...
    static {
        try {
            ...
            HELD_API = (IGeneriTechApi) apiField.get(apiClass);
        } catch (ClassNotFoundException ex) {
            throw new CoreInaccessibleException("GeneriTech API tried to access the " + CORE_API_FQN + " class, without it being declared");
        } catch (NoSuchFieldException ex) {
            throw new CoreInaccessibleException("GeneriTech API tried to access the " + CORE_API_FIELD + " field in " + CORE_API_FQN + " without it being declared");
        } catch (IllegalAccessException ex) {
            throw new CoreInaccessibleException("GeneriTech API tried to access the " + CORE_API_FIELD + " field in " + CORE_API_FQN + " without enough access permissions");
        }
    }

    public static IGeneriTechApi instance() {
        return HELD_API;
    }
}
