...
package com.sandvoxel.generitech.client.gui.misc;
...
/**
 * Created by Sean on 21/05/2016.
 */
public class GuiUpgrades extends GuiBase {
    private TileEntityMachineBase tileEntity;
    private MachineTier machineTier;
    private GuiHelper guiHelper = new GuiHelper();

    public GuiUpgrades(InventoryPlayer inventoryPlayer, TileEntityMachineBase tileEntity) {
        super(new ContainerUpgrades(inventoryPlayer, tileEntity));
    ...
    public void drawBG(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        bindTexture("gui/misc/upgrades.png");
