...
import com.sandvoxel.generitech.common.tileentities.power.TileEntityDebugGenerator;
import net.minecraft.block.material.Material;
import net.minecraft.block.state.BlockStateContainer;
import net.minecraft.block.state.IBlockState;
import net.minecraft.util.EnumFacing;

public class BlockDebugTeslaGenerator extends BlockTileBase {
    public BlockDebugTeslaGenerator() {
        super(Material.rock, "power/debug-gen");
        this.setDefaultState(blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH));
        this.setTileEntity(TileEntityDebugGenerator.class);
        this.setCreativeTab(GeneriTechTabs.GENERAL);
        this.setInternalName("debuggenerator");
    }
