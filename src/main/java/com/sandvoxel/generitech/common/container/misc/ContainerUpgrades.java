...
package com.sandvoxel.generitech.common.container.misc;
...
public class ContainerUpgrades extends ContainerBase{
    private MachineTier machineTier;

    public ContainerUpgrades(InventoryPlayer inventoryPlayer, TileEntityMachineBase tileEntity)
    {
