...
public interface IWailaTailMessage {
    List<String> getWailaTailToolTip(ItemStack itemStack, List<String> currentTip, IWailaDataAccessor accessor, IWailaConfigHandler config);
}
