...
package com.sandvoxel.generitech.common.items.upgrades;
...
import com.sandvoxel.generitech.common.items.ItemBaseUpgrade;
...
public class ItemFortuneUpgrade extends ItemBaseUpgrade {
    public ItemFortuneUpgrade()
    {
        super("upgrades/fortune", MachineTier.TIER_1, MachineTier.TIER_2, MachineTier.TIER_3);
        this.setInternalName("fortuneupgrade");
    }
    ...
    public void registerItemRenderer() {
        ...
        for (MachineTier machineTier : machineTiers) {
            ModelLoader.setCustomModelResourceLocation(this, machineTier.getMeta(), new ModelResourceLocation(Reference.MOD_ID + ":" + resourcePath + "-t" + machineTier.getMeta() , "inventory"));
        }
    }
}
