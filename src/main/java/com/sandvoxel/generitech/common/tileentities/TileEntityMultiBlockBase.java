...
public abstract class TileEntityMultiBlockBase extends TileEntityInventoryBase {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbtTagCompound) {
        ...
        multiBlockData.setInteger("masterX", masterX);
        multiBlockData.setInteger("masterY", masterX);
        multiBlockData.setInteger("masterZ", masterX);
        multiBlockData.setBoolean("hasMaster", hasMaster);
